...
async function home(inReq, _outResp) {
  let fiters = '';
  let classes = [
    { type_id: '1', type_name: '电影片库' },
    { type_id: '2', type_name: '国产剧片库' },
    { type_id: '21', type_name: '韩剧片库' },
    { type_id: '22', type_name: '美剧片库' },
    { type_id: '3', type_name: '综艺片库' },
    { type_id: '4', type_name: '动漫片库' },
    { type_id: '20', type_name: '纪录片片库' },
  ];
  let filterObj = {
    1: [
      {
