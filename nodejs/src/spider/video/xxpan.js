...
async function home(inReq, _outResp) {
  const classes = [
    { type_id: 'ali-yun-pan-list', type_name: '阿里云盘' },
    { type_id: 'kua-ke-wang-pan-list', type_name: '夸克云盘' },
    { type_id: 'video-tv-list', type_name: '影视资源' },
    { type_id: 'cartoon-list', type_name: '动漫天堂' },
  ];
  const filterObj = {};
  return {
    class: classes,
