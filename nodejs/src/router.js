...
import ikan from './spider/video/ikanbot.js';
 
const spiders = [douban,live,bili,baipiao,meijumi,ikan,wogg,xxpan,yingso,upyun,pansearch,push, alist, _13bqg,copymanga,laobaigs,bengou,baozimh,bookan];
