...
import xxpan from './spider/video/nongmin.js';




const spiders = [douban,live,bili,baipiao,meijumi,nongmin,vcm3u8,wogg,xxpan,yingso,upyun,pansearch,push, alist, _13bqg,copymanga,laobaigs,bengou,baozimh,bookan];
